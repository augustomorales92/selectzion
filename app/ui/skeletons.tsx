...
export function HomeSkeleton() {
  return (
    <div className={`${shimmer} relative overflow-hidden rounded-xl bg-gray-100 p-2 shadow-sm`}>
      <header className="flex items-end justify-center rounded-lg bg-gray-50 p-4 md:h-32">
      ...
      <footer className="flex items-end justify-center rounded-lg bg-gray-50 p-4 md:h-32">
