...
export function Footer() {
  return (
    <footer className="flex flex-col items-center justify-center bg-gray-50 p-1 md:h-32 md:flex-row md:p4">
      <div className=''>
        ...
        <div className="flex scale-75 justify-center space-x-4 md:mx-auto md:mb-4 md:w-1/3 md:transform-none md:justify-between">
        ...
        <div className="mt-4 md:mt-0 md:flex md:w-1/3 md:justify-end scale-75  md:transform-none">
